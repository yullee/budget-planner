...
//    NSLog(@"The test button is clicked.");
//}
...
-(void)presentPlaidLinkWithCustomConfiguration {
    ...
    @try {
        linkConfiguration = [[PLKConfiguration alloc] initWithKey:@"8dab9a5bd2f9dd9ec6c1d03b1f4ca1" env:PLKEnvironmentSandbox product:PLKProductAuth];
        linkConfiguration.clientName = @"ITP 342";
        id<PLKPlaidLinkViewDelegate> linkViewDelegate  = self;
...
@implementation MainViewController (PLKPlaidLinkViewDelegate)
